...
syn match cssIdentifierError "[A-Z_][A-Z0-9_]*"

syn match cssColorError contained "#[A-Za-z0-9][A-Za-z0-9]*"
syn match cssColorError contained "[0-9][A-Fa-f0-9]*"
syn match cssColorError contained "[A-Fa-f]+[0-9]+[A-Fa-f0-9]*"

"syn match cssMissingSemicolonError ":\([^;]*[^ \n\t;]+[^;]*\)+:"
syn match cssMissingSemicolonError contained ":[^:;]\([^;]*\n[^;]*\)*:"
...
syn match cssValueError contained "[A-Za-z_]\+[0-9]\+[A-Za-z0-9_]"

syn match cssFontDescriptor "@font-face\>" nextgroup=cssFontDescriptorBlock skipwhite skipnl
syn region cssFontDescriptorBlock contained transparent matchgroup=cssBraces start="{" end="}" contains=cssComment,cssError,cssUnicodeEscape,cssFontProp,cssFontAttr,cssCommonAttr,cssStringQ,cssStringQQ,cssFontDescriptorProp,cssFontDescriptorFunction,cssUnicodeRange,cssFontDescriptorAttr
...
syn match cssUIProp contained "\<\(border-box\|appearance\|icon\|resize\)\>"
...
syn region cssDefinition transparent matchgroup=cssBraces start='{' end='}' contains=css.*Attr,css.*Prop,cssComment,cssValueError,cssColorError,cssValueInteger,cssValueNumber,cssValueLength,cssValueAngle,cssValueTime,cssValueFrequency,cssColor,cssURL,cssImportant,cssError,cssStringQ,cssStringQQ,cssFunction,cssUnicodeEscape,cssVendor,cssDefinition,cssMissingSemicolonError 
syn match cssBraceError "}"

" Pseudo class
syn match cssPseudoClass ":[A-Za-z0-9_-]*" contains=cssErrorClass,cssPseudoClassId,cssUnicodeEscape
syn keyword cssPseudoClassId link visited active hover focus before after left right lang
syn match cssErrorClass "[A-Za-z0-9_][A-Za-z0-9_]*"
...
if version >= 508 || !exists("did_css_syn_inits")
  ...
  HiLink cssIdentifierError Error
  HiLink cssColorError Error
  HiLink cssValueError Error
  HiLink cssErrorClass Error
  HiLink cssMissingSemicolonError Error
